            ...
            <div className="row d-flex align-items-center">
              ...
              {(toggleMenu || screenWidth > 576) && (
                <ul className="col list m-0 p-0 nav justify-content-end">
                  ...
                  <li className="nav-item">
                    <Link className="nav-link bold active" to="/services">
                      SERVICES
                    </Link>
                  </li>
                  <li className="nav-item">
          ...
          <div className="row d-flex justify-content-center">
            <div className="col-11 col-md-7 mt-2">
              <p className="text-center">
                We provide software development, maintenance, support,
                deployment and implementation services as well as Web
                Development and Mobile Apps for both Android and iOS.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-11 col-md-10">
            <div className="row">
              ...
              <div className="col-12 col-md services-s1-1 m-2 p-4 d-flex flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    We provide 360 solutions ranging from communication, social
                    networking and entertainment mobile apps for Android and
                    iOS.
                  </p>
                </div>
              </div>
              ...
              <div className="col-12 col-md services-s1-1 m-2 p-4 d-flex flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    We offer unmatched eCommerce services to our users that help
                    businesses expand & deliver value to their customers.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="services-s2">
        <div className="row">
          ...
          <div className="row d-flex justify-content-center">
            <div className="col-11 col-md-7 mt-2">
              <p className="text-center">
                Our team is trained to solve problems and provide innovative
                solutions tailored carefully to meet client needs.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="col-11 col-md-10">
            <div className="row">
              <div className="col-12 col-md services-s2-1 m-2 p-4 d-flex justify-content-center flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    Our bunch of professional designers and developers assists
                    you in building successful and quality products.
                  </p>
                </div>
              </div>
              ...
              <div className="col-12 col-md services-s2-1 m-2 p-4 d-flex justify-content-center flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    Our enthusiastic squad of well equipped personals helps you
                    build reliable products by offering Performance and Security
                    Testing, Mobile and Manual Testing.
                  </p>
                </div>
              </div>
              ...
              <div className="col-12 col-md services-s2-1 m-2 p-4 d-flex justify-content-center flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    Our richly experienced team will provide you with the best
                    possible back-end and front-end architect solution for your
          ...
          <div className="col-11 col-md-10">
            <div className="row">
              ...
              <div className="col-12 col-md services-s2-2 m-2 p-4 d-flex flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    Digital Marketing, Marketing Analysis, Marketing
                    Coordination, Designing Marketing Material, Sales
                    Development etc.
                  </p>
                </div>
              </div>
              <div className="col-12 col-md services-s2-2 m-2 p-4 d-flex flex-column bd-highlight ">
                ...
                <div className="p-2 bd-highlight">
                  <p className="justify">
                    We offer best practices of fulfilling all your business
                    needs by providing through analysis of your requirement and
